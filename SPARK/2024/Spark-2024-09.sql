...
DROP TABLE IF EXISTS DATATIER_DATASTRUCTURES;
CREATE TABLE DATATIER_DATASTRUCTURES (
...
ALTER TABLE DATATIER_DATASTRUCTURES ADD CONSTRAINT xpk_DATATIER_DATASTRUCTURES PRIMARY KEY (DATASTRUCTURECOREID);
