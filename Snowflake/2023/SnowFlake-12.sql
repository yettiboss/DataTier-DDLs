...
CREATE TABLE DATAGENERATED_EIN (
    ...
    EINVALUE VARCHAR(10),
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_PLATFORM_DATAREQUEST_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDUSER VARCHAR(20),
    REGISTEREDAPP CHAR(38)
);
...
CREATE TABLE PLATFORM_APPSETTINGS_GENERAL (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_PLATFORM_APPSETTINGS_GENERAL_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    REGISTEREDAPP CHAR(38),
...
CREATE TABLE PLATFORM_CONFIG_DATAATTRIBUTES (
    ...
    DATAGENTYPEID NUMBER,
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_PLATFORM_CONFIG_DATAATTRIBUTES_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDUSER VARCHAR(20),
...
CREATE TABLE PLATFORM_CONFIG_DATASTRUCTURES (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_PLATFORM_CONFIG_DATASTRUCTURES_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDUSER VARCHAR(20),
...
CREATE TABLE PLATFORM_CONFIG_DATASTRUCTURES_DTL (
    ...
    SENSITIVITYFLAGID NUMBER,
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_PLATFORM_CONFIG_DATASTRUCTURES_DTL_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDUSER VARCHAR(20),
...
CREATE TABLE PLATFORM_DATAATTRIBUTES (
    ...
    SENSITIVITYFLAGID NUMBER,
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_PLATFORM_DATAATTRIBUTES_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDUSER VARCHAR(20),
...
CREATE TABLE PLATFORM_INDUSTRYSTDS_METADATA (
    ...
    SENSITIVITYFLAGID NUMBER,
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_PLATFORM_INDUSTRYSTDS_METADATA_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDUSER VARCHAR(20)
);
...
CREATE TABLE REFDATA_APPLICATION (
     ...
     CREATEDUSER VARCHAR(20),
     CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
     STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_APPLICATION_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
     VENDORID NUMBER,
...
CREATE TABLE REFDATA_CODESET (
    ...
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_CODESET_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    CREATEDUSER VARCHAR(20),
    CODESETGUID CHAR(38),
...
CREATE TABLE REFDATA_CODESETS_CROSSMAPS (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_CODESETS_CROSSMAPS_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDUSER VARCHAR(20),
...
CREATE TABLE REFDATA_COUNTRIES (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_COUNTRIES_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_DATAGENTYPES (
    ...
    DATAATTRIBUTEID NUMBER,
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_DATAGENTYPES_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
    CREATEDUSER VARCHAR(20)
);
...
CREATE TABLE REFDATA_DEVICETYPES (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID INT NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_DEVICETYPES_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_INDUSTRIESTOBUSINESS (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_INDUSTRIESTOBUSINESS_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_INDUSTRYSTD (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_INDUSTRYSTD_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_INDUSTRYSTD_EVENTTYPES (
    ...
    INDUSTRYSTD VARCHAR(6),
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_INDUSTRYSTD_EVENTTYPES_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_INDUSTRYSTD_EVENTTYPES_GROUPERS (
    ...
    INDUSTRYSTD VARCHAR(6),
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_INDUSTRYSTD_EVENTTYPES_GROUPERS_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_LEGALENTITIES (
     ...
     ZIPCODE VARCHAR(12),
     CREATEDUSER VARCHAR(20),
     STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_LEGALENTITIES_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
...
CREATE TABLE REFDATA_OPERATIONTYPE (
     ...
     CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
     STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_OPERATIONTYPE_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_ORGANIZATION (
      ...
      ZIPCODE VARCHAR(12),
      CREATEDUSER VARCHAR(20),
      STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_ORGANIZATION_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
      CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP() NOT NULL,
...
CREATE TABLE REFDATA_PLATFORMPARAMS (
      ...
      CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
      STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_PLATFORMPARAMS_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_PLATFORMPARAMSTODATAATTRIBUTES (
      ...
      DATAATTRIBUTEID NUMBER,
      CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
      STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_PLATFORMPARAMSTODATAATTRIBUTES_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
      REGISTEREDAPP CHAR(38)
);
...
CREATE TABLE REFDATA_PROFESSIONTYPES (
       ...
       CREATEDUSER VARCHAR(20),
       CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
       STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_PROFESSIONTYPES_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_REGEXTYPES (
       ...
       CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
       STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_REGEXTYPES_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
...
CREATE TABLE REFDATA_RULESETS (
       ...
       CREATEDUSER VARCHAR(20),
       CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
       STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_RULESETS_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_RULESETSDEFINITIONS (
       ...
       STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_RULESETSDEFINITIONS_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
       CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
...
CREATE TABLE REFDATA_SENSITIVITYFLAG (
       ...
       CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
       STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_SENSITIVITYFLAG_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_TERMINOLOGYSTD (
        ...
        CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
        STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_TERMINOLOGYSTD_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_TIMEZONES (
        ...
        CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
        STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_TIMEZONES_STATUS REFERENCES PUBLIC.REFDATA_STATUS
);
...
CREATE TABLE REFDATA_USSTATES (
        ...
        CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
        STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_USSTATES_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
        CREATEDUSER VARCHAR(20)
);
...
CREATE TABLE REFDATA_VENDOR (
        ...
        CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
        STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_REFDATA_VENDOR_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
        CREATEDUSER VARCHAR(20),
        VENDORGUID CHAR(38)
);
...
CREATE TABLE TERMS_CODESET_INDUSTRYSTD (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_TERMS_CODESET_INDUSTRYSTD_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
