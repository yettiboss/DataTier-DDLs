...
CREATE TABLE APIS (
     ...
     APINAME VARCHAR(79),
     CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
     STATUSID NUMBER DEFAULT 1 CONSTRAINT FK_PLATFORM_DATAREQUEST_STATUS
     REFERENCES PUBLIC.REFDATA_STATUS,
     PURPOSE VARCHAR(49),
...
CREATE TABLE DATABUILT_DATASTRUCTUES (
    ...
    CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
    STATUSID NUMBER DEFAULT 1
    CONSTRAINT FK_PLATFORM_DATAREQUEST_STATUS REFERENCES PUBLIC.REFDATA_STATUS,
...
CREATE TABLE DATAEXISTING_NAMEFIRST (
    FIRSTNAMEID NUMBER IDENTITY CONSTRAINT PK_AUDITING_DATAREQUEST PRIMARY KEY,
...
CREATE TABLE DATAEXISTING_NAMELAST (
    LASTNAMEID NUMBER IDENTITY CONSTRAINT PK_AUDITING_DATAREQUEST PRIMARY KEY,
                                       LASTNAME VARCHAR(69),
                                       STATUSID NUMBER DEFAULT 1
    CONSTRAINT FK_PLATFORM_DATAREQUEST_STATUS
    REFERENCES PUBLIC.REFDATA_STATUS NOT NULL,
                                       CREATEDDATE TIMESTAMPNTZ DEFAULT CURRENT_TIMESTAMP(),
                                       CREATEDUSER VARCHAR(20),
                                       REGISTEREDAPP CHAR(38),
...
CREATE TABLE DATAGENERATED_CUSTOM (
                                      DATAGENCUSTOMDID NUMBER IDENTITY
    CONSTRAINT PK_AUDITING_DATAREQUEST
    PRIMARY KEY,
